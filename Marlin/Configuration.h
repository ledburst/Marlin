...
#define STRING_CONFIG_H_AUTHOR "(ledburst)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "pwrd by Marlin 1.1.9  "
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 400, 400, 200 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -21.8  // Z offset: -below +above  [the nozzle]
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MIN_PROBE_EDGE (DELTA_PRINTABLE_RADIUS - 30)
...
#define MANUAL_Z_HOME_POS 325.8 // Distance between the nozzle to printbed after homing
